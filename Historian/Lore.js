...
var cnItems = {
    ...
    'stairwell, I’ll simply move terrain around to bury it. ': '楼梯间，我会简单地移动地形来掩埋它。',
    'gather machine parts. Instead of masking the entrance ': '收集机器零件。 而不是掩盖入口',
    'structure didn’t even shift. I’m going back to the city to ': '结构甚至没有改变。 我要回城去',
    'left small holes in the walls they were fixed to, the entire ': '在它们固定的墙壁上留下了小孔，整个',
    'small explosives in a couple of locations at once. While they ': '一次在几个位置放置小型炸药。 虽然他们',
    'structure steady. My durability testing included detonating ': '结构稳定。 我的耐久性测试包括引爆',
    'remodeled into long and sturdy poles, holding the entire ': '改造成长而坚固的杆子，支撑着整个',
    'with delicate Firelights. Along the outside, rocks have been ': '带着精致的火光。 在外面，岩石已经',
    'ground. Several small connected rooms, everything lit up ': '地面。 几个相连的小房间，一切都亮了起来',
    '50 meters and height of 4 meters, located far beneath the ': '50 米和 4 米的高度，位于远低于',
    'time around. A circular underground room with a diameter of ': '时间。 一个圆形地下室，直径为',
    'than I thought it would be, but I had big requirements this ': '比我想象的要好，但我有很大的要求',
    'Finally, the space for my experiments is ready. It was harder ': '终于，我的实验空间准备好了。 更难',
    'I’ve disguised my arms with a long coat because I don’t want ': '',
    '': '',
    '': '',
    '': '',
    '': '',
