...
function runEvent(eventId) {
	switch(eventId) {
		...
		case "upgradeBought13":
			...
			document.getElementById("machineProductInfo3").innerHTML="5 土地";
			break;
		case "upgradeBought14":
			...
			document.getElementById("machineProductInfo3").innerHTML="6 土地";
			break;
		case "upgradeBought16":
			...
			document.getElementById("machineProductInfo3").innerHTML="8 土地";
			break;
